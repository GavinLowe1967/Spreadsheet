...
%
\begin{scala}
def produceFacts(r: Row): Boolean = 
  if(r == firstEmpty) true
  else{ Cell(out, r) = fact(Cell(In,r)); produceFacts(r+1) }
val b = produceFacts(#0)
\end{scala}
%
The function |produceFacts(r)| writes the factorials into rows \SCALA{r until
  firstEmpty}.  (The returned |Boolean| is a dummy value: it is necessary
since all functions must return a result.)
