...
The expression |Cell(c,r)| represents the value in the spreadsheet cell
in column~|c| and row~|r|.  In the case where |c| and |r| are column and row
...
rows.    When a cell is read, the script should define what
