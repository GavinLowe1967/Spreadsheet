...
The characters ``\SCALA{//}\,'' turn the rest of the line into a comment.  Block
comments (maybe spanning multiple lines, and maybe nested) can be written
between ``\SCALA{/}\SCALA{*}'' and~``\SCALA{*/}\,''.
