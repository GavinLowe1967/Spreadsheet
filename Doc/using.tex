...
The application uses the Scala Swing library, so the jar
file\footnote{Available from \url{https://scala-lang.org/files/archive/}.}
needs to be on the classpath.  I use the following command (except all on one
line): {\small
\begin{verbatim}
